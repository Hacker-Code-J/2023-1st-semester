...
int main() {
	...
	\begin{example}
		...
		\begin{center}
			...
			%add straight line
			\draw[line width=0.25mm, red] (-1.5,-1.5) -- (2.5,2.5) node[above] {$(1:1)$};
			\draw[line width=0.25mm, red] (-3,-1.5) -- (4,2) node[above] {$(2:1)$};
			\draw[line width=0.25mm, red] (0,-1.5) -- (0,2.5) node[above right] {$(0:1)$};
			\draw[line width=0.25mm, red] (-5,0) -- (5,0) node[above] {$(1:0)$};
			% draw point
